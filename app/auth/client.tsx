  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        ...
        description: "Start organizing your leads and contacts",
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Organize your sales and contacts, all in one place.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                A modern CRM dashboard for teams that want to grow. Secure access, clear sales workflow, and beautiful onboarding.
              </p>
            </div>
            <div className="relative overflow-hidden rounded-2xl border border-secondary/70 bg-background/80 p-3 shadow-lg">
              <Image
                src="/demo-img.jpg"
                alt="LeadNest CRM preview"
              ...
              {mode === "signin" ? (
                <form className="space-y-4" action={signInAction}>
                  ...
                  <Button type="submit" className="w-full" disabled={isPending}>
                    {isPending ? "Signing in..." : content.primaryButton}
                  </Button>
                </form>
              ) : (
                <form className="space-y-4" action={signUpAction}>
                  ...
                  <Button type="submit" className="w-full" disabled={isPending}>
                    {isPending ? "Creating account..." : content.primaryButton}
                  </Button>
                </form>
              )}
